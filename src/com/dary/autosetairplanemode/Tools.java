...
public class Tools {
    ...
    public static void makeToastSetAirPlaneMode(Context context, boolean isOn, long time,
            boolean isRepeat) {
        ...
        Toast.makeText(
                context,
                context.getString(R.string.set_airplane_mode_auto)
                        + (isRepeat ? context.getString(R.string.repeat_everyday) : "")
                        + (isOn ? context.getString(R.string.on) : context.getString(R.string.off))
                        + context.getString(R.string.at) + formatter.format(calendar.getTime()),
